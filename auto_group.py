...
# %%
section_roster_files = find_files('txt', '.')
...
course_roster_file = find_files('csv', '.')
...
for _file in section_roster_files:
    ...
    try:
        ...
        course_df = pd.merge(course_df, section_df[['name', 'group_name']],  how='left', 
             left_on=['name'], right_on = ['name'], suffixes=('_x','')).drop(columns=['group_name_x'])
    except:
        print('No section found.')
        pass
    
    # section_roster_lst.append(_roster)
# %%
